...
public class FormerJapaneseTokenizer implements org.deeplearning4j.text.tokenization.tokenizer.Tokenizer {
  ...
  public FormerJapaneseTokenizer(String toTokenize) {
  ...
  // Mode.SEARCH
  // Mode.EXTENDED
  public FormerJapaneseTokenizer(String toTokenize, Mode mode, boolean useBaseForm) {
    this(
  ...
  public FormerJapaneseTokenizer(Tokenizer tokenizer, String toTokenize, boolean useBaseForm) {
